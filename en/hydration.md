...
When using a compression tool to compress Vue rendered HTML, you need to avoid compressing HTML and causing DOM structural changes, such as deleting empty lines, spaces, and so on.
